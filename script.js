...
const questions=["Quel est le type d'un fichier JavaScript?", "Comment fair un commentaire sur une ligne avec javaScript?", "Dans quel élément HTML place-t-on le JavaScript ?",
...
function afficheReponse(){
    reponse[indexQuestion].forEach( function(sousReponse) {
...
btnAccueil.addEventListener("click", (e)=>{
    ...
    contenairePage.style.display = "block";
